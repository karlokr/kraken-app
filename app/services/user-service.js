...
exports.register = function (user) {
    var promise = fetchModule.fetch(
        "https://ecocitythegame.ca/sqlconnect-kraken/register.php", {
            method: "POST",
            headers: {
...
exports.login = function (user) {
    var promise = fetchModule.fetch(
        "https://ecocitythegame.ca/sqlconnect-kraken/login.php", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
exports.resetPassword = function (email) {
    var promise = httpModule.request({
        url: "https://ecocitythegame.ca/sqlconnect-kraken/resetpw.php",
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
